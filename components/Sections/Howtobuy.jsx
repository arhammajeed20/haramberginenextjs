const steps = [
  {
    ...
    description: "Prepare a vessel for Harambe's soul. Install MetaMask or Trust Wallet.",
  },
  {
    emoji: "💰",
    title: "2. Load ETH 💰",
    description: "Prepare the offering to summon the spirit. Buy ETH from an exchange and transfer it to your wallet.",
  },
  {
    emoji: "🔗",
    title: "3. Connect Wallet 🔗",
    description: "Connect your soul with Harambe. Connect your wallet to the Harambergine website.",
  },
  {
    emoji: "🚀",
    title: "4. Buy Tokens 🚀",
    description: "Summon Harambe in eggplant form. Enter the desired ETH amount and purchase HBE tokens.",
  },
  {
    emoji: "✅",
    title: "5. Verify Tokens ✅",
    description: "You are now a guardian of the meme. Add the token address to your wallet to verify your HBE tokens.",
  },
]
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold mb-8 text-center">
            <span className="text-white">🦍 How to Meet the Gorilla Who Became an Eggplant 🍆</span>
          </h2>
          <p className="text-xl text-center text-gray-300 mb-12 max-w-2xl mx-auto">
            We guide you through the sacred ritual of bringing Harambe's soul into your wallet.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="rounded-lg border-2 text-card-foreground shadow-[0_5px_15px_rgba(128,0,255,0.3)] bg-purple-900/20 border-purple-700">
              <div className="p-6">
                <h2 className="text-2xl font-bold mb-4 text-center">Join the Presale</h2>
                ...
                <p className="text-gray-300 mb-6 text-center">
                  Participate in the presale to be among the first to acquire Harambergine tokens. Tokens are minted to
                  your wallet immediately upon purchase.
                </p>
            ...
            <div className="rounded-lg border-2 text-card-foreground shadow-[0_5px_15px_rgba(128,0,255,0.3)] bg-purple-900/20 border-purple-700">
              <div className="p-6">
                <h2 className="text-2xl font-bold mb-4 text-center">Add Token to Wallet</h2>
                <div className="flex justify-center mb-6">
                ...
                <p className="text-gray-300 mb-6 text-center">
                  After purchase, add the token address to your wallet to immediately verify your tokens. The token
                  address can be found in the presale widget.
                </p>
                <div className="flex justify-center">
